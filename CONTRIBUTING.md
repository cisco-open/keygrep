...
3. If you've changed any invocation options, update the documentation.
...
## Report bugs using Github's [issues](https://github.com/cisco-open/keygrep/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/cisco-open/keygrep/issues).
...
## References
This document was adapted from [here](https://github.com/cisco-open/BLAZE/blob/main/CONTRIBUTING.md).
